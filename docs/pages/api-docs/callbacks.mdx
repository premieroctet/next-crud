...
A request has arrived and the callback is executed right before any action on the database. It receives 4 arguments: the request, the response and an object containing the route type, the resource id and the resource name.
